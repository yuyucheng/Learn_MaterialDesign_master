 ...
 * @author: yuyucheng
 */
public class TestThreeRxJava extends AppCompatActivity{
    @Override
    ...
    private void toLogin(){
        final RetrofitApi api= RetrofitProvider.get().create(RetrofitApi.class);
        api.regist(new RegisterRequest())
